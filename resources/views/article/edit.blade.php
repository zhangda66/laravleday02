    ...
    <div class="container-fluid">
        ...
        <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" placeholder="文章标题" name="title"value="{{$article->title}}" >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="a_id" class="form-control">
                        ...
                        <option >请选择类别</option>
                        @foreach($rows as $a)
                            <option value="<?=$a['id']?>"   <?php if($a['id']===$article['a_id'])echo "selected"?> ><?=$a['name']?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="content"cols="60" rows="10" placeholder="文章内容">{{$article->content}}</textarea>
                </div>
            </div>
            <div class="form-group">
